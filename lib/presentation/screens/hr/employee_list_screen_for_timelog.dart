...
class EmployeeListScreenForTimelog extends StatefulWidget {
  const EmployeeListScreenForTimelog({super.key});

  @override
  State<EmployeeListScreenForTimelog> createState() => _EmployeeListScreenStateForTimelog();
}

class _EmployeeListScreenStateForTimelog extends State<EmployeeListScreenForTimelog> {
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                context.push('/hr/staff-time-logs', extra: user);
                              },
                            ),
                          );
                        },
