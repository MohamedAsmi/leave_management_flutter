...
class _TimeAdjustmentApprovalScreenState
  ...
  List<TimeAdjustmentRequestModel> _filterRequests(
    ...
    return requests
        .where((r) => r.status.toLowerCase() == _selectedStatus.toLowerCase())
        .toList();
  }
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          ...
          '${DateFormat('MMM d, yyyy').format(request.date.toLocal())}?',
        ),
        actions: [
          TextButton(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (request.approvedLeaveType != null) ...[
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Approved Leave: ${request.approvedLeaveType}',
                        style: TextStyle(
